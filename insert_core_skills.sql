...
-- 1.1 Welding
INSERT INTO core_skill_categories (id, name, created_at)
VALUES (NEWID(), 'Welding', GETDATE());

DECLARE @WeldingId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Welding' ORDER BY created_at DESC);
...
DECLARE @LatheId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Lathe' ORDER BY created_at DESC);
...
DECLARE @MillId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Mill' ORDER BY created_at DESC);
...
DECLARE @GearboxId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Gearbox' ORDER BY created_at DESC);
...
DECLARE @PumpsId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Pumps' ORDER BY created_at DESC);
...
DECLARE @PneumaticsId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Pneumatics' ORDER BY created_at DESC);
...
DECLARE @HydraulicsId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Hydraulics' ORDER BY created_at DESC);
...
DECLARE @ElecKnowId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Electrical Knowledge' ORDER BY created_at DESC);
...
DECLARE @ElecHandId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Electrical Hand Skills' ORDER BY created_at DESC);
...
DECLARE @MotorsId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Motors' ORDER BY created_at DESC);
...
DECLARE @InvertersId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Inverters' ORDER BY created_at DESC);
...
DECLARE @ControlPanelsId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Control Panels' ORDER BY created_at DESC);
...
DECLARE @RSLinxId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'RSLinx' ORDER BY created_at DESC);
...
DECLARE @Logix500Id UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Rockwell Logix 500' ORDER BY created_at DESC);
...
DECLARE @Logix5000Id UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Rockwell Logix 5000' ORDER BY created_at DESC);
...
DECLARE @Studio5000Id UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Rockwell Studio 5000' ORDER BY created_at DESC);
...
DECLARE @ABInvertersId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Allen Bradley Inverters' ORDER BY created_at DESC);
...
DECLARE @StaubliId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Staubli Robots' ORDER BY created_at DESC);
...
DECLARE @MitsubishiId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Mitsubishi GX Developers' ORDER BY created_at DESC);
...
DECLARE @ABBId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'ABB Robots' ORDER BY created_at DESC);
...
DECLARE @CognexId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Cognex Camera Insight' ORDER BY created_at DESC);
...
DECLARE @SiemensS7Id UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Siemens S7' ORDER BY created_at DESC);
...
DECLARE @SiemensTIAId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Siemens TIA' ORDER BY created_at DESC);
...
DECLARE @SiemensInvId UNIQUEIDENTIFIER = (SELECT TOP 1 id FROM core_skill_categories WHERE name = 'Siemens Inverters' ORDER BY created_at DESC);
